package minek.web.spring.storage
...
import minek.web.spring.storage.exception.FileNotFoundException
import minek.web.spring.storage.exception.StorageException
...
class LocalFileStorageService(val location: String = "./uploads") :
    FileStorageService {
    ...
    override fun store(file: MultipartFile): String {
        ...
        try {
            ...
            throw StorageException(
                "Failed to store file $newFilename",
                e
            )
        }
        return newFilename
